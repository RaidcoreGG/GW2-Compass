...
void draw_scene() {
    ...
    // Scale
    XMFLOAT3 scale = XMFLOAT3(1.0f, 0.01f, 1.0f);
    ...
    XMFLOAT3 position = XMFLOAT3(MumbleLink->AvatarPosition.X, MumbleLink->AvatarPosition.Y + 0.9f, MumbleLink->AvatarPosition.Z);
